...
import java.util.*;
import net.javabackend.IntegrationTest;
import net.javabackend.config.Constants;
import net.javabackend.domain.User;
import net.javabackend.repository.AuthorityRepository;
...
import net.javabackend.service.dto.PasswordChangeDTO;
import net.javabackend.web.rest.vm.KeyAndPasswordVM;
import net.javabackend.web.rest.vm.ManagedUserVM;
